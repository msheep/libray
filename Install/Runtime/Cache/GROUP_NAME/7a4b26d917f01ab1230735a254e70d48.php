...
<head>
	<meta charset="utf-8">
	<title>DSSHOP-Dswjcms安装程序</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta name="description" content="DSSHOP傻瓜式一键安装，佣有一套商城只需10秒">
	<meta name="KeyWords" content="DSSHOP安装,dsshop一键安装,dsshop程序安装">
    <meta name="generator" content="DSSHOP!" />
...
<body>
	<div class="container index">
        ...
        <div class="name">DSSHOP</div>
        <div id="sp-1" <?php if(($state) == "1"): ?>class="hide"<?php endif; ?>>
            <div class="describe">傻瓜式安装，搭建商城最快只需10秒</div>
